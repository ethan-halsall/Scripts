...
make ARCH=arm64 O=${OUT_DIR} revenge_defconfig
...
rm -f ${OUT_DIR}/zip-out/simple-*-dipper-Pie.zip

cd ${zipdirout}

release=$(date +%Y""%m""%d)
zipfile="simple-${release}-dipper-revenge-clang-11.0.0.zip"
...
rm -f /home/ethan/Desktop/Kramel/simple-*-dipper-Pie.zip
